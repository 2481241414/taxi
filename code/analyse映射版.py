...
if __name__ == '__main__':
    ...
    analyse(file_path=f'/home/workspace/lgq/data/inference/打车语料-2.0版 - 车型理解_inference_results_{date_str}.csv', version='v2.0')
    # analyse(file_path=f'/home/workspace/lgq/data/inference/全新训练数据20250613_10percent_inference_results_0613.csv', version='全新训练数据20250613_10percent_inference_results_0613')
    # output_file = '/home/workspace/lgq/data/inference/merge_data_inference_results.csv'
